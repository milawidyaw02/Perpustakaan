...
<head>
    ...
    <title>E-Perpus Registrasi</title>
            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block ms-3">
                        <img src="img/buku.png" alt="gbr_login" style="width:450px">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            @endif
                            <form class="user" action="/aksiRegistrasi" method="post" enctype="multipart/form">
                                @csrf 
